...
def ekf(z_k_observation_vector, state_estimate_k_minus_1, 
    ...
    print('State Estimate Before EKF={}'.format(state_estimate_k))
    ...
    print('Observation={}'.format(z_k_observation_vector))
    ...
    print('State Estimate After EKF={}'.format(state_estimate_k))
